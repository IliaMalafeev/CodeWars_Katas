...
/* <------------------------------------------------
    ...
    know whether the board's current state is solved, wouldn't we?
...
public class K24_TicTacToeChecker {

    public static void main(String[] args) {

        int[][] board1 = {{0, 0, 1}, {0, 1, 2}, {2, 1, 0}};
        int[][] board2 = {{0, 1, 1}, {0, 1, 2}, {2, 1, 0}};
        int[][] board3 = {{0, 0, 2}, {0, 2, 1}, {2, 1, 0}};
        int[][] board4 = {{1, 2, 1}, {1, 1, 2}, {2, 1, 2}};
        int[][] board5 = {{1, 2, 1}, {1, 1, 2}, {2, 1, 0}};
        int[][] board6 = {{1, 2, 1}, {1, 1, 2}, {2, 2, 2}};
        ...
        System.out.println(isSolved(board6));
    }
