...
/* <------------------------------------------------
    ...
    Examples:
        ...
        queueTime([10,2,3,3], 2) ===> should return 10, because here n=2 and the 2nd, 3rd, and 4th people in the queue
                                      finish before the 1st person has finished.

        queueTime([2,3,10], 2) ===> should return 12

    Clarifications:
        There is only ONE queue serving many tills, and the order of the queue NEVER changes.
        The front person in the queue (i.e. the first element in the array/list) proceeds to a till as soon as it becomes free.
        N.B. You should assume that all the test input will be valid, as specified above.
---------------------------------------------------> */

public class K39_TheSupermarketQueue {
    ...
    public static int queueTime (int[] array, int n) {
