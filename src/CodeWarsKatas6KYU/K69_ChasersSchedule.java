...
/* <------------------------------------------------
    ...
    After sprinting, base speed s will permanently be reduced by 1, and for next one
    unit of time runner will enter recovery phase and can't sprint again.

    Your task, given base speed s and time t, is to find the maximum possible distance d.

    Input:  1 <= s < 1000,   1 <= t < 1000

    Example: Given s = 2 and t = 4.
