...
/* <------------------------------------------------
    ...
    On each side we have the following races, with their associated worth:

        Forces of good: Hobbits: 1, Men: 2, Elves: 3, Dwarves: 3, Eagles: 4, Wizards: 10

        Forces of evil: Orcs: 1, Men: 2, Wargs: 2, Goblins: 2, Uruk Hai: 3, Trolls: 5, Wizards: 10

    Although weather, location, supplies and valor play a part in any battle, if you add up the worth of the
    side of good and compare it with the worth of the side of evil, the side with the larger worth will tend to win.
